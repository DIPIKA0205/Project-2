...
public class HomeInventory1 extends JFrame
{
// Toolbar
...
{
// create frame
new HomeInventory1().show();
}
public HomeInventory1()
...
ImageIcon(HomeInventory1.photoTextArea.getText()).getImage();
int w = getWidth();
int h = getHeight();
...
{
Graphics2D g2D = (Graphics2D) g;
if ((pageIndex + 1) > HomeInventory1.lastPage)
{
return NO_SUCH_PAGE;
}
int i, iEnd;
...
iEnd = HomeInventory1.entriesPerPage * (pageIndex + 1);
if (iEnd > HomeInventory1.numberEntries)
iEnd = HomeInventory1.numberEntries;
for (i = 0 + HomeInventory1.entriesPerPage * pageIndex; i < iEnd; i++)
{
// dividing line
...
g2D.drawString(HomeInventory1.myInventory[i].description, (int) pf.getImageableX(), y);
y += dy;
g2D.setFont(new Font("Arial", Font.PLAIN, 12));
g2D.drawString("Location: " + HomeInventory1.myInventory[i].location, (int)
(pf.getImageableX() + 25), y);
y += dy;
if (HomeInventory1.myInventory[i].marked)
...
HomeInventory1.myInventory[i].serialNumber, (int) (pf.getImageableX() + 25), y);
y += dy;
g2D.drawString("Price: $" + HomeInventory1.myInventory[i].purchasePrice + ",Purchased on: " + HomeInventory1.myInventory[i].purchaseDate, (int) (pf.getImageableX() +25), y);
y += dy;
g2D.drawString("Purchased at: " +HomeInventory1.myInventory[i].purchaseLocation, (int) (pf.getImageableX() + 25), y);
y += dy;
g2D.drawString("Note: " + HomeInventory1.myInventory[i].note, (int)(pf.getImageableX() + 25), y);
y += dy;
try
{
// maintain original width/height ratio
Image inventoryImage = new
ImageIcon(HomeInventory1.myInventory[i].photoFile).getImage();
